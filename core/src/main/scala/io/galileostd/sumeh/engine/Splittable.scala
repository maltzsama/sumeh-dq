 ...
 *
 * @param DF The engine-specific validated data type (e.g. `ValidatedSparkDataFrame`).
 */
trait Splittable[DF] {
   ...
   *
   * @param df The validated dataset.
   * @return A `(good, bad)` tuple; bad rows carry the quality errors.
   */
