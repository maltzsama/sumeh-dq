...
object ValidationLevel {
   ...
   *
   * @param s The level name, `"ROW"` or `"TABLE"` (case-insensitive).
   * @return The matching [[ValidationLevel]].
   * @throws java.lang.IllegalArgumentException when the name is unknown.
   */
